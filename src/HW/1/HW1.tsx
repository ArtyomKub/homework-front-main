...
export const HW1 = () => {
	...
	// 1️⃣ Раскомментируйте JSX (HW1.tsx, UserList.tsx) и вы увидите, 	DONE
	// что приложение начнет гореть красным и ругаться 😡 				DONE
	// 2️⃣ Ваша задача: ❗ПОЧИНИТЬ ПРОЕКТ❗								DONE
